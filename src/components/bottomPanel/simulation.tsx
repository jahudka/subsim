    ...
    <div id="simulation" className="table">
      <div className="row">
        ...
        <div className="flex-min">
          <NumericField value={frequency} min={20} max={250} step={1} onChange={(f) => dispatch($.sim.set('frequency', f))}>hz</NumericField>
        </div>
      ...
      <div className="row">
        ...
        <div className="flex-min">
          <NumericField value={gain} min={-24} max={24} step={1} onChange={(g) => dispatch($.sim.set('gain', g))}>dB</NumericField>
        </div>
      ...
      <div className="row">
        ...
        <div className="flex-min">
          <NumericField value={range} min={12} max={54} step={3} onChange={(r) => dispatch($.sim.set('range', r))}>dB</NumericField>
        </div>
      ...
      <div className="row">
        ...
        <div className="flex-min">
          <NumericField value={step ?? 0} min={0} max={6} step={3} onChange={(r) => dispatch($.sim.set('step', r || undefined))}>dB</NumericField>
        </div>
      ...
      <div className="row">
        ...
        <div className="flex-min">
          <NumericField value={$c.value} min={$c.min} max={$c.max} step={1} onChange={($c) => dispatch($.var.set('$c', $c, true))}>m/s</NumericField>
        </div>
